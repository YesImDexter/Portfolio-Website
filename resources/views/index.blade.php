...
<body>
                    ...
                    <div class="col-md-7 sm-padding wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <div class="about-content">
                            ...
                            <ul class="profile-info">
                                <li><span>Full Name</span> Dexter Skudd </li>
                                <li><span>Age</span> 21 </li>
                                <!-- <li><span>Address</span> 962 Fifth Avenue, 3rd Floor New York.</li> -->
                    ...
                    <div class="col-md-6 sm-padding wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms">
                        ...
                        <ul class="exp-list">
                            ...
                            <li>
                                ...
                                <div class="exp-content">
                                    <h4>Self-Employment. <span>Freelancer</span></h4>
                                    <p>I love to work in User Experience & User Interface designing. Because I love to solve the design problem and find easy and better solutions to solve it.</p>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 sm-padding wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <div class="services-item">
                            ...
                            <p>Uniquely incentivize systems for reliable market. Authoritatively scale next generation. </p>
                            <div class="dots"></div>
                        </div>
                    </div>
                    ...
                    <div class="row portfolio-items">
                        <div class="col-md-4 col-sm-6 padding-10 single-item design">
                            <div class="portfolio-box">
                                <img src="img/port-1.jpg" alt="img">
                                <div class="portfolio-content">
                                    <h3><a class="img-popup" href="img/port-1.jpg">Design Studio<span>Branding</span></a></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 padding-10 single-item branding marketing">
                            <div class="portfolio-box">
                                ...
                                <div class="portfolio-content">
                                    <h3><a class="img-popup" href="img/port-2.jpg">Design Studio<span>Branding</span></a></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 padding-10 single-item design marketing">
                            <div class="portfolio-box">
                                <img src="img/port-3.jpg" alt="img">
                                <div class="portfolio-content">
                                    <h3><a class="img-popup" href="img/port-3.jpg">Design Studio<span>Branding</span></a></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 padding-10 single-item marketing wordpress">
                            <div class="portfolio-box">
                                <img src="img/port-4.jpg" alt="img">
                                <div class="portfolio-content">
                                    <h3><a class="img-popup" href="img/port-4.jpg">Design Studio<span>Branding</span></a></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 padding-10 single-item wordpress branding">
                            <div class="portfolio-box">
                                <img src="img/port-5.jpg" alt="img">
                                <div class="portfolio-content">
                                    <h3><a class="img-popup" href="img/port-5.jpg">Design Studio<span>Branding</span></a></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 padding-10 single-item design">
                            <div class="portfolio-box">
                                <img src="img/port-6.jpg" alt="img">
                                <div class="portfolio-content">
                                    <h3><a class="img-popup" href="img/port-6.jpg">Design Studio<span>Branding</span></a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-innter">
                            ...
                            <div class="testi-content">
                                ...
                                <h4>Melania Rose <span>Twitter.CO</span></h4>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- jQuery -->
    <!-- <script src="js/vendor/jquery-1.12.4.min.js"></Dexter>
